...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"erin-music","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/***/ 13:
/*!***************************************************!*\
  !*** D:/code/ErinMusic/erin-music/store/index.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
new _vuex.default.Store({
  ...
  mutations: {
    setDuData: function setDuData(state, value) {
      console.log('stateValue', value);
      state.duData = value;
      uni.setStorageSync('duData', value);
    },
    removeDuData: function removeDuData(state) {
      state.duData = [];
...
/***/ 15:
/*!****************************************************************!*\
  !*** D:/code/ErinMusic/erin-music/store/modules/songDetail.js ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var getters = {
  // 热门评论
  hotCommentsList: function hotCommentsList(state) {return state.songCommentObj.hotComments || [];},
  // 最新评论
...
var actions = {
  getSongComments: function getSongComments(_ref,


  value) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var commit, state, res, oldComments, obj;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:commit = _ref.commit, state = _ref.state;_context.next = 3;return (
                _songInfo.default.songComments({
                  ...
                  cursor: value.cursor || '' }));case 3:res = _context.sent;
...
/***/ 19:
/*!****************************************************!*\
  !*** D:/code/ErinMusic/erin-music/api/songInfo.js ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...

{
  ...
  songUrl: function songUrl(data) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                (0, _request.request)({
                  url: "/song/url/v1?id=".concat(data.id, "&level=").concat(data.level || 'standard') }));case 2:return _context.abrupt("return", _context.sent);case 3:case "end":return _context.stop();}}}, _callee);}))();

  },
  // 获取音乐歌词
  lyric: function lyric(id) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:_context2.next = 2;return (
                (0, _request.request)({
                  url: "/lyric?id=".concat(id) }));case 2:return _context2.abrupt("return", _context2.sent);case 3:case "end":return _context2.stop();}}}, _callee2);}))();
  ...
  songComments: function songComments(data) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee3() {return _regenerator.default.wrap(function _callee3$(_context3) {while (1) {switch (_context3.prev = _context3.next) {case 0:_context3.next = 2;return (
                (0, _request.request)({
                  url: "/comment/new?id=".concat(data.id, "&type=").concat(data.type, "&pageNo=").concat(data.pageNo, "&pageSize=").concat(data.pageSize, "&sortType=").concat(data.sortType, "&cursor=").concat(data.cursor) }));case 2:return _context3.abrupt("return", _context3.sent);case 3:case "end":return _context3.stop();}}}, _callee3);}))();

  },
  // 楼层评论  type:0-歌曲、1-mv、2-歌单、3-专辑、4-电台节目
  floorComments: function floorComments(data) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee4() {return _regenerator.default.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:_context4.next = 2;return (
                (0, _request.request)({
                  url: "/comment/floor?parentCommentId=".concat(data.parentId, "&id=").concat(data.songId, "&type=").concat(data.type, "&time=").concat(data.time) }));case 2:return _context4.abrupt("return", _context4.sent);case 3:case "end":return _context4.stop();}}}, _callee4);}))();
...
/***/ 5:
/*!***********************************************!*\
  !*** D:/code/ErinMusic/erin-music/pages.json ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports) {
